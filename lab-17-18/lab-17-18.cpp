...
//extern "C" pair<double, double> calc3(double x1, double y1, double x2, double y2, double x3, double y3);
...
int main() {
    ...
    auto asmAns = calc3(x1, y1, x2, y2, x3, y3);
    cout << "asm p=" << asmAns.first << ", s=" << asmAns.second << endl;
    double dx1 = x1 - x2;
    double dx2 = x2 - x3;
    double dx3 = x3 - x1;
